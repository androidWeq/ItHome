 ...
 */
public class Photoes_ShowAllPhoto extends Activity {
	...
	private class PreviewListener implements OnClickListener {
		public void onClick(View v) {
			if (Bimp.tempSelectBitmap.size() > 0) {
				...
				intent.setClass(Photoes_ShowAllPhoto.this, Photoes_GalleryActivity.class);
	...
	private class BackListener implements OnClickListener {// 返回按钮监听
		...
		public void onClick(View v) {
			intent.setClass(Photoes_ShowAllPhoto.this, Photoes_ImageFile.class);
			startActivity(intent);
		}
				...
				.setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
					public void onItemClick(final ToggleButton toggleButton,
						...
						if (Bimp.tempSelectBitmap.size() >= PublicWay.num&&isChecked) {
							...
							Toast.makeText(Photoes_ShowAllPhoto.this, Res.getString("only_choose_num"), 200)
									.show();
							return;
						}
